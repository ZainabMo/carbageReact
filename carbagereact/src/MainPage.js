  ...
  render() {
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        <button style={{width: 40, marginRight: 10, position: "relative"}}>
          <svg id="home-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{paddingTop: 5, marginLeft: -5, marginRight:-4}}>
          ...
          <svg id="pin-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" style={{fill:"#d81e5b", width: 15, position:"absolute", left: 23, top: 3}}>
...
export class TipSidebar extends React.Component{
  render() {
    return (
      <div>
        <h3>Good morning, John
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{height:20}}>
          ...
          <section>
            <ul>
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" style={{width: 35}}>
...
export class QuickLook1 extends React.Component{
  render() {
    return (
      <div>
